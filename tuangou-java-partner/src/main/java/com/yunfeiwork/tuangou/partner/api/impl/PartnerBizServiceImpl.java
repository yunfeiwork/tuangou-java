...
import static com.yunfeiwork.tuangou.partner.constant.ApiUrlConstants.*;
...
public class PartnerBizServiceImpl implements PartnerBizService {
    ...
    public Response<AppBindShopResult> bindMeituanShop(AppBindMeituanShop param) {
        ...
        if (StringUtils.isBlank(param.getMtAccountName())) {
            return Response.fail("商家资质 -> 公司名称 or 账号中文名称不能为空");
        }
